...
```{r} 
# decide to include eval or echo??
library(tidyverse)
...
When we look at the table, we see that knn = 2, it has the largest mean and the largest standard deviation. knn = 5 has the lowest standard deviation and knn = 10 has the lowest mean. 
